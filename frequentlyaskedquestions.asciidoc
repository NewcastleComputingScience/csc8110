...
=== Advice on selection of Partition and Row Keys

The following link provides a good (but very comprehensive) guide to designing your Table Storage tables, including the selection of appropriate Partition and Row Keys. 

https://azure.microsoft.com/en-gb/documentation/articles/storage-table-design-guide/
