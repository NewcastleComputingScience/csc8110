...
In addition to the source code, we would like to see evidence (either in textual output, or screenshot form) demonstrating each area of functionality you have completed as part of the assignment. These should be included in your report document (with sufficient screen resolution so the images are legible), or included as images as part of your zip file and carefully named to suggest which area of functionality they pertain to.
